...
@section('content')
    <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
        <div class="!px-10 !py-12 card-body">
            <a href="#!">
                <img src="{{ URL::to('assets/images/book.png') }}" alt="" class="hidden h-6 mx-auto dark:block">
                <img src="{{ URL::to('assets/images/book.png') }}" alt="" class="block h-6 mx-auto dark:hidden">
            </a>
